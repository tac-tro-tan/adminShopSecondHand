    ...
    useEffect(() => {
        const fetchData = async (req, res) => {
            try {
                ...
                const response = await fetch('https://localhost:7071/api/Feedback/get?page=' + pagee
                    + '&pageSize=5', requestOptions)
                                ...
                                <tr className="border-top" key={index}>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <Link to={"/chitietgopy/" + feed.id} style={{ textDecoration: "none" }} >
